...
const styles = StyleSheet.create({
  ...
  menuContainer: { position: 'absolute', backgroundColor: '#2E2E2E', borderRadius: 16, padding: 4, minWidth: 160, ...SHADOW.lg, borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)' },
