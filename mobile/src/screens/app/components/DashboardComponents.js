...
const styles = StyleSheet.create({
  ...
  greetingLabel:   { fontSize: 10, ...FONT.medium, color: '#94A3B8', letterSpacing: 1.5 },
  greeting:        { fontSize: 24, ...FONT.bold, color: '#1F2937', marginTop: 2, letterSpacing: -0.5 },
  ...
  sectionTitle:    { fontSize: 14.5, ...FONT.semibold, color: '#1F2937', letterSpacing: -0.3 },
  ...
  countBadge: { backgroundColor: '#F1F5F9', paddingHorizontal: 10, paddingVertical: 3, borderRadius: 8 },
