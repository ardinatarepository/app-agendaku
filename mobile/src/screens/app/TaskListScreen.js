...
function PrioritySelector({ value, onChange }) {
  const configs = {
    RENDAH: { label: 'Rendah', active: { bg: '#334155', border: '#94a3b8', text: '#f8fafc' } },
    NORMAL: { label: 'Normal', active: { bg: '#1e293b', border: '#3b82f6', text: '#3b82f6' } },
    TINGGI: { label: 'Tinggi', active: { bg: '#450a0a', border: '#ef4444', text: '#f87171' } },
  };
  return (
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 22, ...FONT.bold, color: COLORS.text, letterSpacing: 0.5 },
  searchRow: { flexDirection: 'row', gap: 12, padding: 16, marginTop: 4, zIndex: 10 },
  searchBox: { 
    flex: 1, 
    flexDirection: 'row', 
    alignItems: 'center', 
  ...
  filterBadge: { position: 'absolute', top: -4, right: -4, width: 18, height: 18, borderRadius: 9, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', borderWeight: 2, borderColor: COLORS.bg },
  filterBadgeText: { fontSize: 10, color: '#fff', ...FONT.bold },
  ...
  chipText: { fontSize: 13, color: COLORS.textMuted, ...FONT.semibold, textAlign: 'center' },
  chipTextActive: { color: COLORS.primary },
  sortBar: { flexGrow: 0, marginBottom: 8, height: 34 },
  sortChip: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, height: 28, borderRadius: 14, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border },
  ...
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 28, marginBottom: 14, marginLeft: 4 },
  sectionTitle: { fontSize: 12, ...FONT.bold, color: COLORS.textLight, textTransform: 'uppercase', letterSpacing: 1.2 },
  sectionBadge: { backgroundColor: COLORS.surface, paddingHorizontal: 10, paddingVertical: 2, borderRadius: 10, marginLeft: 6, borderWidth: 1, borderColor: COLORS.border },
  sectionBadgeText: { fontSize: 10, ...FONT.bold, color: COLORS.textMuted },
  fab: { position: 'absolute', bottom: 24, right: 24, width: 64, height: 64, backgroundColor: COLORS.primary, borderRadius: 32, alignItems: 'center', justifyContent: 'center', ...SHADOW.lg },
...
const mStyle = StyleSheet.create({
  ...
  title: { fontSize: 18, ...FONT.bold, color: COLORS.text },
  cancel: { fontSize: 15, color: COLORS.textMuted, ...FONT.medium },
  save: { fontSize: 15, color: COLORS.primary, ...FONT.bold },
  body: { padding: 20, paddingBottom: 250 },
  label: { fontSize: 13, ...FONT.bold, color: COLORS.textMuted, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 0.5 },
  datePickerBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  datePickerText: { fontSize: 15, color: COLORS.text, ...FONT.medium },
  chip: { 
    paddingHorizontal: 16, 
    paddingVertical: 10, 
  ...
  chipText: { fontSize: 13, ...FONT.semibold, color: COLORS.textMuted, textAlign: 'center' },
  input: { 
    borderWidth: 1.5, 
    borderColor: COLORS.border, 
    borderRadius: RADIUS.md, 
  ...
  subTaskText: { flex: 1, fontSize: 14, color: COLORS.text, ...FONT.medium, marginLeft: 10 },
});
...
const prioStyle = StyleSheet.create({
  ...
  label: { fontSize: 13, ...FONT.bold, color: COLORS.textMuted },
});

const fStyle = StyleSheet.create({
  overlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.7)' },
  sheet: { backgroundColor: COLORS.surface, borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 24, paddingBottom: 40, ...SHADOW.lg },
  handle: { width: 40, height: 5, backgroundColor: COLORS.border, borderRadius: 3, alignSelf: 'center', marginBottom: 20, marginTop: -8 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 },
  title: { fontSize: 18, ...FONT.bold, color: COLORS.text },
  reset: { fontSize: 14, color: COLORS.primary, ...FONT.bold },
  secLabel: { fontSize: 12, ...FONT.bold, color: COLORS.textLight, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 },
