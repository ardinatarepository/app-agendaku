...
export default function DashboardScreen({ navigation }) {
  ...
  useEffect(() => {
    if (data?.tugasMendekatiDeadline?.length) {
      rescheduleAllNotifications(data.tugasMendekatiDeadline).catch(() => {});
    }
  }, [data]);
      ...
      <View style={styles.section}>
        ...
        {isLoading ? (
          ...
          <Card style={{ padding: 20, alignItems: 'center' }}>
            <Ionicons name="sparkles" size={28} color={COLORS.primary} style={{ marginBottom: 6 }} />
...
const styles = StyleSheet.create({
  ...
  content:         { padding: 20 },
  topBar:          { backgroundColor: COLORS.primary, padding: 24, paddingTop: 60, paddingBottom: 40, borderBottomLeftRadius: 30, borderBottomRightRadius: 30, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginHorizontal: -20, marginTop: -20, marginBottom: 24, ...SHADOW.md },
