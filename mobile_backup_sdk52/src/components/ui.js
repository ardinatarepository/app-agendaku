...
// ─── ConfirmModal ─────────────────────────────────────────────────────────────
export const ConfirmModal = ({ visible, title, message, onConfirm, onCancel, confirmText = 'Hapus', cancelText = 'Batal', variant = 'danger', iconName }) => (
    ...
    <View style={{ flex: 1, backgroundColor: 'rgba(15, 23, 42, 0.6)', justifyContent: 'center', alignItems: 'center', padding: 24 }}>
       <View style={{ backgroundColor: COLORS.surface, borderRadius: RADIUS.lg, width: '100%', padding: 24, ...SHADOW.md }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
             <Button title={cancelText} variant="secondary" style={{ flex: 1 }} onPress={onCancel} />
             <Button title={confirmText} variant={variant} style={{ flex: 1 }} onPress={onConfirm} />
          </View>
       </View>
    </View>
  </Modal>
